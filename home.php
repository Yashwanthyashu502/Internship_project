	...
	<section class="section">
      <div class="row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" name="chiefcomplaint" id="chiefcomplaint" aria-label="Default select example">
					   <option selected>Select your complaint</option>
                        <option value="PainintheTooth">Pain in the Tooth</option>
                        <option value="Foodlodgement">Food lodgement</option>
                        <option value="Mobileteeth">Mobile teeth</option>
                        <option value="DisplacedTeeth">Displaced Teeth</option>
						 <option value="Toothappearslong">Tooth appears long</option>
						 <option value="other">other</option>
                      </select>
                    </div>
                  </div>
       ...
       <div class="row mb-3">
			  ...
			  <div class="col-md-12">
                   <form method="post">
					<input type="submit" name="submit1" id="submit1" value="PREDICT" class="btn btn-primary"> 
					</form>
                  </div>
              <hr>
              <?php $ret=mysqli_query($con,"select * from tblpredicted");
			  $num=mysqli_num_rows($ret); 
              while($row=mysqli_fetch_array($ret)){ ?>
                <h2 class="card-title" style="color:red;">Predicted Diagnosis Result : <?php echo $row['pred'];?></h2>
              <?php } ?>
